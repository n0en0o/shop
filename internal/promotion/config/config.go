...
func Load() (Config, error) {
	...
	cfg := Config{
		...
		MetricsPort:    getEnv("PROMOTION_METRICS_PORT", defaultMetricsPort),
	}
...
func (c Config) Validate() error {
	...
	if strings.TrimSpace(c.MetricsPort) == "" {
		missing = append(missing, "PROMOTION_METRICS_PORT")
	}
